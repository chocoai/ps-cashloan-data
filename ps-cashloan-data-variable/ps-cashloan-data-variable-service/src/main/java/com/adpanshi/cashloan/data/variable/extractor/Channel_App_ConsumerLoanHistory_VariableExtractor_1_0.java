 ...
 */
@Service
public class Channel_App_ConsumerLoanHistory_VariableExtractor_1_0 implements VariableExtractor {
    private static Logger logger = LoggerFactory.getLogger(Channel_App_ConsumerLoanHistory_VariableExtractor_1_0.class);
    @Override
